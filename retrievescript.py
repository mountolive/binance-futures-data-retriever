...
today = datetime.datetime.combine(datetime.date.today(),
                                  datetime.time.fromisoformat('00:00'))
later = datetime.datetime.combine(today,
                                  datetime.time.fromisoformat('08:00'))
...
parser.add_argument('--start',
                    help='Date or time for the starting point of data gathering. \
                         Should be in iso format',
                    default=today.isoformat())

parser.add_argument('--end',
                    help='Date or time for the ending point of data gathering. \
                         Should be in iso format',
                    default=later.isoformat())

parser.add_argument('--timeframe',
                    help='The timeframe for the candles: 1m or 3m or 5m...',
                    default='1m')
